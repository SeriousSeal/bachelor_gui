...
import IndexSizeInput from '../components/visual/IndexSizeInput';
...
describe('IndexSizeInput', () => {
    ...
    test('renders tab buttons correctly', async () => {
        render(
            <IndexSizeInput
        ...
        expect(screen.getByRole('tab', { name: /individual inputs/i })).toBeInTheDocument();
        expect(screen.getByRole('tab', { name: /bulk input/i })).toBeInTheDocument();
    });
